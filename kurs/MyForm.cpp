...
inline System::Void kurs::MyForm::MyForm_Load(System::Object^ sender, System::EventArgs^ e) {
    ...
    F1->name = "";
    F1->description = "       ()   . \n   .  ( ),     , ,   .";
    F1->address = "453434,  ,  , . , . , . 71";
    F1->email = "inbox@polief.sibur.ru";
    F1->reputation = "10";
    F1->staff_numbers = "743";
   
    F2->id = 1;
    F2->name = "";
    F2->description = "     ,            [1][2][3].     .";
    F2->address = "450037,  ,  , . .";
    F2->email = "report@bashneft.ru";
    F2->reputation = "10";
    F2->staff_numbers = "3430";

}

System::Void kurs::MyForm::ToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e)
{
    if (MessageBox::Show(
        " ,   ?",
...
System::Void kurs::MyForm::infoMenuItem_Click(System::Object^ sender, System::EventArgs^ e)
{
    if (tabControl->SelectedTab->Name == "tabPage_p") {
        ...
        MessageBox::Show(gcnew System::String(info.c_str()), " ", MessageBoxButtons::OK);
    }
    else if (tabControl->SelectedTab->Name == "tabPage_uos") {
...
inline System::Void kurs::MyForm::dataGridView_MouseClick(System::Object^ sender, System::Windows::Forms::MouseEventArgs^ e)
{
    ...
    System::Windows::Forms::MenuItem^ editMenuItem = gcnew MenuItem("");
    System::Windows::Forms::MenuItem^ deleteMenuItem = gcnew MenuItem("");
    System::Windows::Forms::MenuItem^ infoMenuItem = gcnew MenuItem("  ");
...
System::Void kurs::MyForm::ToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e)
{
    ...
    MessageBox::Show("     : " + gcnew System::String(summary_amount_of_items(goods1, n1).ToString()), "", MessageBoxButtons::OK);
}
...
System::Void kurs::MyForm::ToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e)
{
    ...
    MessageBox::Show("     : " + gcnew System::String(summary_amount_of_items(goods2, n2).ToString()), "", MessageBoxButtons::OK);
}

System::Void kurs::MyForm::ToolStripMenuItem1_Click(System::Object^ sender, System::EventArgs^ e)
{
    if (!goods1 || !goods2) {
        MessageBox::Show("  !", "!", MessageBoxButtons::OK, MessageBoxIcon::Warning);
        return;
    ...
    dataGridView_p->FirstDisplayedScrollingRowIndex = index;
    tabControl->SelectTab("tabPage_p");
    MessageBox::Show("     1  : " + gcnew System::String(std::to_string(max).c_str()) + " .", "!", MessageBoxButtons::OK, MessageBoxIcon::Information);
